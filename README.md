...
Remarque: Dans un premier notre projet est certes inspiré du Sars-Cov-2, cependant plus nous rentrons dans le détail de notre projet, plus nos facteurs devienent des variables. Ainsi les recherches sont devenus non essentielle puisque tous nos paramètres sont modifiable.

Pour la consulter : [Bibliothèque](https://github.com/are-dynamic-2024-g3/Sars-cov-2/blob/main/Biblioth%C3%A8que.md)
